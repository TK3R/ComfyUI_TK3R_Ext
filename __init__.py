# code lifted from WAS Extras, thanks WAS
...
class NodeLoader:
    ...
    def print_intro(self) -> None:
        msg = "A few enhanced vanilla nodes as well as some utility nodes. No warranty."
        if console:
            # Single rule and a single-titled panel
            console.rule(style="cyan")
            console.print(Panel(msg, title="TK3R Ext", border_style="cyan"))
        else:
            print(f"{self.prefix}A few enhanced vanilla nodes as well as some utility nodes. No warranty.")
